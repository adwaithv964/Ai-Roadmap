...
export const motivationalAlerts = {
    general: [
        "Great job! Every step forward is a step towards your goal.",
        "Nice one! Keep up the fantastic momentum.",
        "You're on a roll! Consistency is key.",
        "Excellent! Another step down.",
        "Awesome work! You're making real progress."
    ],
    milestone: [
        "Milestone alert! You're making incredible progress!",
        "Big achievement unlocked! You're crushing it.",
        "Look how far you've come! Milestone reached."
    ],
    streak: [
        "Streak extended! You're building a great learning habit.",
        "On fire! Keep that streak going.",
        "Consistency unlocked! Another day, another win."
    ],
    first_step: [
        "And so it begins! The first step is the most important. Well done!",
        "You've started your journey! This is going to be epic."
    ],
    stage_complete: [
        "Module Complete! You've mastered a whole new section.",
        "Boom! Another module cleared. What's next?",
        "You've conquered the entire module! Time for the next challenge."
    ]
};

export const landingCategories = [
    { id: 'dev', title: 'Software Development', description: 'Build beautiful and interactive applications for web and mobile.', image: 'https://placehold.co/1920x1080/2d2d2d/ffffff?text=Code' },
    { id: 'data', title: 'Data & AI', description: 'Extract insights and knowledge from data using scientific methods.', image: 'https://placehold.co/1920x1080/2a2a2a/ffffff?text=Data' },
    { id: 'cloud', title: 'IT & Cloud', description: 'Manage infrastructure, operations, and cloud computing services.', image: 'https://placehold.co/1920x1080/323232/ffffff?text=Cloud' },
    { id: 'design', title: 'Design & Creative', description: 'Design intuitive and engaging user experiences for digital products.', image: 'https://placehold.co/1920x1080/303030/ffffff?text=Design' },
    { id: 'security', title: 'Cybersecurity', description: 'Protect systems, networks, and programs from digital attacks.', image: 'https://placehold.co/1920x1080/282828/ffffff?text=Security' },
    { id: 'emerging', title: 'Emerging Tech', description: 'Explore the future with blockchain, IoT, and cutting-edge technologies.', image: 'https://placehold.co/1920x1080/343434/ffffff?text=Future' },
    { id: 'business', title: 'Business & Finance', description: 'Master financial principles, entrepreneurship, and business management.', image: 'https://placehold.co/1920x1080/363636/ffffff?text=Business' },
    { id: 'marketing', title: 'Marketing', description: 'Learn strategies to promote products and connect with customers.', image: 'https://placehold.co/1920x1080/383838/ffffff?text=Marketing' },
];
