                    ...
                    <div className="w-full max-w-2xl mx-auto bg-gray-800 bg-opacity-50 backdrop-blur-sm p-8 rounded-lg border border-gray-700">
                        {submitted ? (
                            ...
                            <form onSubmit={handleSubmit} className="space-y-6 animate-fade-in-up">
                                ...
                                <button
                                    type="submit"
                                    disabled={!feedback || rating === 0 || status === 'submitting'}
                                    className="w-full bg-yellow-400 text-black font-bold py-3 px-6 rounded-full hover:bg-yellow-300 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                                >
